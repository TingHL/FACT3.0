...
def main(radare, nginx):
    ...
    with OperateInDirectory('../web_interface/static'):
        ...
        _patch_bootstrap()
        wget_static_web_content('http://code.jquery.com/jquery-1.12.0.min.js', 'bootstrap/js', ['mv jquery-1.12.0.min.js jquery.min.js'], 'jquery')
        ...
        wget_static_web_content('https://code.angularjs.org/1.4.8/angular.min.js', '.', [], 'angularJS')
